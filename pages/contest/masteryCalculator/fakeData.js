export default {
  notes:[
    ...
    "金车选6000，半金少选1，满星无金卡少选2，低星几星就选几，高星可适当加几个。",
    "当前所有进度总和为 913，如何获得 967 进度宝箱以及 800 进度后会有什么新任务，还请拭目以待。"
  ],
  toolCars:[
    {
      car_id: '1789',
  ...
  chapters:[

    {
      ...
      processRewards:[
        { 
          conditions: 16,
          rewards:[ { type: 'bpFromKey', count: 30 } ]  
        },
...

    {
      ...
      missions:[
        ...
        },
        {
          toolCarId:'392',
          rankList:[
            899, 1291, 1784, 2096, 2152
          ]
        },
      ]
    },
    {
      targetCarId:'saleens1',
      unlockConditions:0,
      processRewards:[
    ...
    },
    {
      ...
      processRewards:[
        { 
          conditions: 26,
          rewards:[ { type: 'bpFromKey', count: 38 } ]  
        },
    ...
    },
    {
      ...
      processRewards:[
        { 
          conditions: 25,
          rewards:[ { type: 'bp', count: 8 } ]  
        },
        { 
          conditions: 30,
          rewards:[ { type: 'ultimateBP', count: 2 } ]  
        },
        { 
          conditions: 41,
          rewards:[ { type: 'bp', count: 85 } ]  
        },
    ...
    },
    {
      ...
      processRewards:[
        ...
        { 
          conditions: 43,
          rewards:[ { type: 'bpFromKey', count: 40 } ]  
        },
    ...
    },
    {
      ...
      processRewards:[
        ...
        { 
          conditions: 45,
          rewards:[ { type: 'bpFromKey', count: 45 } ]  
        },
