...
<script>
  // [三种 Loading 制作方案] https://mp.weixin.qq.com/s?__biz=MzA4Nzg0MDM5Nw==
  export default {
    data() {
      return {
...
<style lang="scss">
  ...
  .loading-css {
    ...
    border-right: 6rpx solid rgba($color: #000000, $alpha: 0);
    /*设置四周边框大小，并将颜色设置为浅白色*/
    border-radius: 50%;
    /*将边框和内容区域都变成圆形*/

    animation: loading-360 0.6s infinite linear;
